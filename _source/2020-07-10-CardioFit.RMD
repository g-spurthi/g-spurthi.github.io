...
**2. Observation based on MaritalStatus**
```{r}
## Bar Chart for Customers By Product
ggplot(Fitness, aes(x = MaritalStatus)) + 
...
* Checking the number of customers by marital status
* We have more number of partnered customers vs single customers.

**3. Observation based on Product**
```{r}
## Bar Chart for Customers By Product
